...
ripqp_bm_minres(QM) = ripqp(QM, iconf = InputConfig(sp = K2_5minresParams(preconditioner = :ActiveCLDL)),
                            itol = InputTol(max_iter=400, max_time=1200.) )#,
