include("/home/mgi.polymtl.ca/geleco/git_workspace/docGL/solvers/qpalm-qm.jl")
...
stats2 = qpalm2(qm2)  # compile code
...
function optimize_osqp(path_pb)
    ...
    return solve_problems(qpalm2, problems)
end
...
file_lp = jldopen(string(save_path, "/qpalm_lp1.jld2"), "w")
file_lp["stats"] = problems_stats_lp
close(file_lp)

problems_stats_qp =  optimize_osqp(path_pb_qp)

file_qp = jldopen(string(save_path, "/qpalm_qp1.jld2"), "w")
