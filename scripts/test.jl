...
qm = QuadraticModel(readqps(string(path_pb, "\\CRE-A.SIF"), mpsformat=:fixed))
...
stats1 = RipQP.ripqp(qm, 
                    ...
                    form_mat = true,
                      ...
                      form_mat = true,
                        # equilibrate = false,
                        preconditioner = RipQP.LDL(fact_alg=RipQP.LLDLFact(mem = 20), T = Float64, pos = :R, warm_start = true),
                        ρ_min=1.0e-8, δ_min = 1.0e-8,
                        mem = 20,
                        itmax = 20,
                    ...
                    scaling = true, history=true, ps=true, mode=:multi, kc=0,
