...
stats1 = RipQP.ripqp(qm, 
                    # sp = RipQP.K2LDLParams(fact_alg = RipQP.LDLFact(regul=:dynamic)),# ρ0=0.1, δ0=0.1),
                    ...
                    form_mat = true,
                      equilibrate = false,
                      preconditioner = RipQP.LDL(fact_alg=RipQP.LLDLFact(mem = 2), T = Float64),
                    ...
                    #         ), 
                     solve_method=RipQP.IPF(), scaling = true, history=true, ps=true, mode=:mono, kc=0,
