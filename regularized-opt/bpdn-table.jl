...
solvers = [:R2, :TRDH, :TRDH, :TRDH, :TR, :TR, :TR, :TR]
subsolvers = [:None, :None, :None, :None, :R2, :TRDH, :TRDH, :TRDH]
solver_options = [options, options, options5, options6, options, options, options, options]
subsolver_options = [options2, options2, options2, options2, options2, options2, options3, options4] # n'importe lequel si subsolver = :None
